...
if ($amount=="exactly")
{
    $find_sql = "SELECT * FROM `food_reviews` WHERE `Rating` = $stars ORDER BY `Food` ASC";
}
...
<div class="box main">
    ...
    <?php
        ...
        ?>
            <div class="results">
                <p>Food: <span class="sub_heading">
                        <?php echo $find_rs['Food']; ?>
                    </span>
                </p>

                <p>Place:<span class="sub_heading">
                        <?php echo $find_rs['Place']; ?>
                    </span>
                </p>

                <p>Time:<span class="sub_heading">
